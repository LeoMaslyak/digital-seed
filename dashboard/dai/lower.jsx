...
function Knowledge BaseCard() {
  ...
  return (
    <div className="card" style={{padding: 22, display:'flex', flexDirection:'column', gap: 14, height:'100%'}}>
      ...
      <div style={{fontSize: 17, fontWeight: 600, letterSpacing:'-0.01em'}}>Knowledge Base</div>
...
function GroupCard() {
  // CUSTOMIZE: Replace with your actual study group members and initials.
  const members = [
    { initials: 'AP', hue: 25,  name: 'Ana P.' },
    { initials: 'KL', hue: 155, name: 'Karim L.' },
    { initials: 'MS', hue: 270, name: 'Mei S.' },
    { initials: 'LM', hue: 195, name: 'Leo M.', self: true },
  ];
  return (
    <div className="card" style={{padding: 22, display:'flex', flexDirection:'column', gap: 14, height:'100%'}}>
      <div style={{display:'flex', alignItems:'center', gap: 10}}>
      ...
      <div style={{fontSize: 17, fontWeight: 600, letterSpacing:'-0.01em'}}>Study Group · Delta</div>
      ...
      <div style={{
        ...
        Nestlé case deck generated by <span style={{color:'var(--fg)', fontWeight: 500}}>Ana P.</span>
      </div>

      <button className="btn" style={{marginTop:'auto', alignSelf:'flex-start'}}>
        Open group context <Icon.ArrowRight size={11} />
      </button>
    </div>
  );
}
...
window.Knowledge BaseCard = Knowledge BaseCard;
